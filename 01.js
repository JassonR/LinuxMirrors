...
!(async()=>{
	...
	_0x22c107.shareUuid='ff55f351b9c343b8aa32b66530511ac6';
	...
	let _0x34e042=[_0x22c107['shareUuid'],''];
	let _0x3ee415=Math['floor'](Math['random']()*10);
	let _0x522e06=0;
	if((_0x3ee415>=1)&&(_0x3ee415<=6))_0x522e06=Math['floor'](Math.random()*_0x34e042.length);
	...
	if(_0x1aeace){
		...
		for(let _0x350e1b of _0x306124){
			...
			if(_0x48eac6.split('=')[1]){
				...
				if(_0x48eac6.indexOf('lz_jdpin_token=')>-1)_0x3b4fe7=(''+_0x48eac6['replace'](/ /g,'')+';');
			}
		}
	}
