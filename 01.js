/*
5.17~6.1 爱尚夏日 大牌献礼 [gua_opencard151.js]
新增开卡脚本 加密
一次性脚本
...
All变量适用
————————————————
入口：[ 5.17~6.1 爱尚夏日 大牌献礼 (https://lzdz-isv.isvjcloud.com/dingzhi/bd/common/activity?activityId=90322051702)]
...
const _0x4d1618=$.isNode()?require('./jdCookie.js'):'';
const _0x4bc6b6=$.isNode()?require('./sendNotify'):'';
let _0x57a51a='';
CryptoScripts();
...
if($.isNode()){
	try{
		...
		if(_0x3166b4.existsSync('./cleancart_activity.js')){
			_0x57a51a=require('./cleancart_activity');
		}
	}catch(_0x357701){}
}
let _0x3dc5f9=[],_0x36cc1c='';
if($.isNode()){
	Object.keys(_0x4d1618).forEach(_0x191475=>{
		_0x3dc5f9['push'](_0x4d1618[_0x191475]);
	});
	if(process.env['JD_DEBUG']&&process['env']['JD_DEBUG']==='false')console.log=()=>{};
}else{
	_0x3dc5f9=[$['getdata']('CookieJD'),$.getdata('CookieJD2'),..._0x506796($.getdata('CookiesJD')||'[]')['map'](_0x21de08=>_0x21de08.cookie)].filter(_0x589acb=>!!_0x589acb);
}
guaopencard_addSku=$['isNode']()?process.env['guaopencard_addSku151']?process.env.guaopencard_addSku151:''+guaopencard_addSku:$['getdata']('guaopencard_addSku151')?$['getdata']('guaopencard_addSku151'):''+guaopencard_addSku;
...
guaopencard=$.isNode()?process['env']['guaopencard151']?process.env['guaopencard151']:''+guaopencard:$.getdata('guaopencard151')?$.getdata('guaopencard151'):''+guaopencard;
...
guaopenwait=$['isNode']()?process['env'].guaopenwait151?process.env['guaopenwait151']:''+guaopenwait:$['getdata']('guaopenwait151')?$.getdata('guaopenwait151'):''+guaopenwait;
...
guaopencard_draw=$.isNode()?process.env.guaopencard_draw151?process['env'].guaopencard_draw151:guaopencard_draw:$.getdata('guaopencard_draw151')?$['getdata']('guaopencard_draw151'):guaopencard_draw;
...
!(async()=>{
	if($.isNode()){
		if(guaopencard+''!='true'){
			console.log('如需执行脚本请设置环境变量[guaopencard151]为"true"');
		}
		if(guaopencard+''!='true'){
			return;
		}
	...
	$.shareUuid='9e4c3cf79da54948b95c411a604226d9';
	console.log('入口:\nhttps://lzdz-isv.isvjcloud.com/dingzhi/bd/common/activity?activityId='+$['activityId']+'&shareUuid='+$.shareUuid);
	let _0x47c391=[$.shareUuid,''];
	let _0x4f0f1e=Math.floor(Math.random()*10);
	let _0x1293f3=0;
	if((_0x4f0f1e>=1)&&(_0x4f0f1e<=6))_0x1293f3=Math['floor'](Math.random()*_0x47c391['length']);
	$.shareUuid=_0x47c391[_0x1293f3]?_0x47c391[_0x1293f3]:$.shareUuid;
	for(let _0x3a18a2=0;_0x3a18a2<_0x3dc5f9.length;_0x3a18a2++){
		_0x36cc1c=_0x3dc5f9[_0x3a18a2];
		if(_0x36cc1c){
			$.UserName=decodeURIComponent(_0x36cc1c.match(/pt_pin=([^; ]+)(?=;?)/)&&_0x36cc1c.match(/pt_pin=([^; ]+)(?=;?)/)[1]);
			$.index=(_0x3a18a2+1);
			message='';
			$['bean']=0;
			$['hotFlag']=false;
			...
			await _0x35badf();
			await _0x447d39();
			if((_0x3a18a2==0)&&!$['actorUuid'])break;
			if($.outFlag||$.activityEnd)break;
		}
	}if($['outFlag']){
		let _0x2419d8='此ip已被限制，请过10分钟后再执行脚本';
		$['msg']($['name'],'',''+_0x2419d8);
		if($.isNode())await _0x4bc6b6.sendNotify(''+$['name'],''+_0x2419d8);
	}if(allMessage){
		$['msg']($.name,'',''+allMessage);
	}
})().catch(_0x3cbd81=>$['logErr'](_0x3cbd81)).finally(()=>$.done());
async function _0x447d39(){
	try{
		...
		await _0x29263f('getSystime');
		await _0x29263f('getSimpleActInfoVo');
		await _0x29263f('getMyPing');
		if(!$.Pin){
		...
		await _0x29263f('accessLogWithAD');
		await _0x29263f('getUserInfo');
		await _0x29263f('activityContent');
		if($['hotFlag'])return;
		if(!$.actorUuid){
		...
		if($.openList.length>0){
			...
			for(o of $.openList){
				...
				await _0x430aac();
				for(let _0x2e05f0=0;_0x2e05f0<Array(5).length;_0x2e05f0++){
					if(_0x2e05f0>0)console.log('第'+_0x2e05f0+'次 重新开卡');
					await _0x39abd6();
		...
		console['log']();
		for(let _0x29bc11 of $.task||[]){
			console.log(_0x29bc11['taskname']+' '+_0x29bc11.curNum+'/'+_0x29bc11.maxNeed+' 获得'+_0x29bc11.rewardIds.replace(';',' ').replace(/chance=(\d+)/,'$1次游戏机会')['replace'](/bean=(\d+)/,'$1京豆').replace(/score=(\d+)/,'$1积分'));
		}
		console.log();
		await _0x29263f('签到详情');
		await _0x29263f('签到');
		if($['outFlag'])return;
		if($.followShop!=2){
			console.log('已完成关注');
		...
		await _0x29263f('我的奖品');
		await _0x29263f('邀请人数');
		if($.outFlag){
			console.log('此ip已被限制，请过10分钟后再执行脚本\n');
			return;
		}
		...
		if(_0x3b58bd)await $['wait'](parseInt(Math.random()*1000+5000,10));
		if(guaopenwait){
			if($['index']!=_0x3dc5f9['length']){
		...
		console.log(_0x5b46ef);
	}
}
async function _0x29263f(_0x1eaa5f){
	if($['outFlag'])return;
	let _0x4493c6='https://lzdz-isv.isvjcloud.com';
	let _0x4991e9='';
	let _0x18a324='POST';
	let _0x84c814='';
	switch(_0x1eaa5f){
		case 'isvObfuscator':
			...
			_0x4991e9='body=%7B%22url%22%3A%22https%3A//lzdz-isv.isvjcloud.com%22%2C%22id%22%3A%22%22%7D&uuid=87bbd44e713417c1da09b54d82d31e40e3792e15&client=apple&clientVersion=10.1.4&st=1651325861763&sv=111&sign=cc7d5321c4c6a5d233fff8828faf0a4e';
			break;
		case 'getSystime':
			url=_0x4493c6+'/common/getSystime';
			_0x4991e9='activityId='+$.activityId;
			break;
		case 'getSimpleActInfoVo':
			url=_0x4493c6+'/dz/common/getSimpleActInfoVo';
			_0x4991e9='activityId='+$.activityId;
			break;
		case 'getMyPing':
			url=_0x4493c6+'/dingzhi/bd/common/getMyPing';
			_0x4991e9='userId='+($['shopId']||$['venderId']||'')+'&token='+$.Token+'&fromType=APP';
			break;
		case 'accessLogWithAD':
			url=_0x4493c6+'/common/accessLogWithAD';
			var _0x2400b9=_0x4493c6+'/dingzhi/bd/common/activity?activityId='+$.activityId+'&shareUuid='+$['shareUuid'];
			_0x4991e9='venderId='+($.shopId||$.venderId||'')+'&code=99&pin='+encodeURIComponent($.Pin)+'&activityId='+$.activityId+'&pageUrl='+encodeURIComponent(_0x2400b9)+'&subType=app&adSource=';
			break;
		case 'getUserInfo':
			url=_0x4493c6+'/wxActionCommon/getUserInfo';
			_0x4991e9='pin='+encodeURIComponent($.Pin);
			break;
		case 'activityContent':
			url=_0x4493c6+'/dingzhi/union/cardgame2205/activityContent';
			_0x4991e9='activityId='+$['activityId']+'&pin='+encodeURIComponent($.Pin)+'&pinImg='+encodeURIComponent($.attrTouXiang)+'&nick='+encodeURIComponent($['nickname'])+'&cjyxPin=&cjhyPin=&shareUuid='+$.shareUuid;
			break;
		case 'info':
			url=_0x4493c6+'/dingzhi/union/cardgame2205/myInfo';
			_0x4991e9='pin='+encodeURIComponent($.Pin)+'&activityId='+$.activityId+'&uid='+$['actorUuid'];
			break;
		case 'drawContent':
			url=_0x4493c6+'/dingzhi/taskact/common/drawContent';
			_0x4991e9='activityId='+$.activityId+'&pin='+encodeURIComponent($['Pin']);
			break;
		case 'checkOpenCard':
			url=_0x4493c6+'/dingzhi/linkgame/checkOpenCard';
			_0x4991e9='pin='+encodeURIComponent($.Pin)+'&activityId='+$['activityId'];
			break;
		case'关注':
			url=_0x4493c6+'/dingzhi/union/cardgame2205/doTask';
			_0x4991e9='taskId=followshop&param=&activityId='+$.activityId+'&pin='+encodeURIComponent($.Pin)+'&uid='+$.actorUuid;
			break;
		case'助力':
			url=_0x4493c6+'/dingzhi/union/cardgame2205/helpFriend';
			_0x4991e9='shareUuid='+$.shareUuid+'&activityId='+$.activityId+'&pin='+encodeURIComponent($['Pin'])+'&uid='+$['actorUuid'];
			break;
		case'签到':
			url=_0x4493c6+'/dingzhi/union/cardgame2205/signIn';
			_0x4991e9='activityId='+$['activityId']+'&pin='+encodeURIComponent($['Pin'])+'&uid='+$.actorUuid;
			break;
		case '签到详情':
			...
			break;
		case '我的奖品':
			url=_0x4493c6+'/dingzhi/bd/common/myprize';
			_0x4991e9='activityId='+$.activityId+'&pin='+encodeURIComponent($.Pin)+'&uid='+$.actorUuid;
			break;
		case '邀请人数':
			url=_0x4493c6+'/dingzhi/bd/common/friendList';
			_0x4991e9='pin='+encodeURIComponent($.Pin)+'&activityId='+$.activityId;
			_0x4991e9='uid='+$['actorUuid']+'&page=1&pageSize=99999&getNum=true&activityId='+$.activityId+'&pin='+encodeURIComponent($.Pin);
			break;
		case'抽奖':
			url=_0x4493c6+'/dingzhi/opencard/draw';
			_0x4991e9='activityId='+$['activityId']+'&actorUuid='+$['actorUuid']+'&pin='+encodeURIComponent($['Pin']);
			break;
		default:
			console.log('错误'+_0x1eaa5f);
	}
	let _0xbf79a1=_0x167281(url,_0x4991e9,_0x18a324);
	return new Promise(async _0x35ec7f=>{
		$['post'](_0xbf79a1,(_0x3bf158,_0x20b181,_0x554cfd)=>{
			try{
				_0x3688e5(_0x20b181);
				if(_0x3bf158){
					if(_0x20b181&&(typeof _0x20b181.statusCode!='undefined')){
						if(_0x20b181['statusCode']==493){
							console.log('此ip已被限制，请过10分钟后再执行脚本\n');
							$.outFlag=true;
						}
					}
					console['log'](''+$['toStr'](_0x3bf158,_0x3bf158));
					console.log(_0x1eaa5f+' API请求失败，请检查网路重试');
				}else{
					_0x4e5050(_0x1eaa5f,_0x554cfd);
				}
			}catch(_0x231108){
				console.log(_0x231108,_0x20b181);
			}
			finally{
				_0x35ec7f();
			}
...
async function _0x4e5050(_0x1c001d,_0x263bf0){
	let _0x15ff79='';
	try{
		if((_0x1c001d!='accessLogWithAD')&&(_0x1c001d!='drawContent')&&(_0x1c001d!='drawContent2')){
			if(_0x263bf0)_0x15ff79=$.toObj(_0x263bf0,_0x263bf0);
			if(_0x1c001d=='isvObfuscator'){
				if(typeof _0x15ff79=='object'){
					if(_0x15ff79.errcode==0){
						if(typeof _0x15ff79['token']!='undefined')$.Token=_0x15ff79.token;
		...
		console.log(_0x1c001d+' 执行任务异常');
		console.log(_0x263bf0);
		$.runFalag=false;
	}try{
		if(_0x15ff79&&(typeof _0x15ff79=='object')){
			if(_0x15ff79&&((_0x15ff79.result===true)&&_0x15ff79['data'])||_0x15ff79.isOk&&(_0x15ff79['isOk']===true)){
				switch(_0x1c001d){
					case 'getSimpleActInfoVo':
						if(typeof _0x15ff79.data.shopId!='undefined')$.shopId=_0x15ff79.data.shopId;
						if(typeof _0x15ff79.data.venderId!='undefined')$.venderId=_0x15ff79.data['venderId'];
						break;
					case 'getMyPing':
						if(typeof _0x15ff79.data['secretPin']!='undefined')$.Pin=_0x15ff79.data.secretPin;
						if(typeof _0x15ff79['data'].nickname!='undefined')$.nickname=_0x15ff79['data'].nickname;
						break;
					case 'getSystime':
						if(typeof _0x15ff79.systime!='undefined')$.JDTime=_0x15ff79.systime;
						break;
					case 'getUserInfo':
						$.attrTouXiang=(typeof _0x15ff79.data.yunMidImageUrl!='undefined')&&_0x15ff79.data['yunMidImageUrl']||'https://img10.360buyimg.com/imgzone/jfs/t1/7020/27/13511/6142/5c5138d8E4df2e764/5a1216a3a5043c5d.png';
						break;
					case '邀请人数':
						$.ShareCount=_0x15ff79.data.friendNum;
						console.log('=========== 你邀请了:'+$.ShareCount+'个');
						console.log();
						break;
					case 'activityContent':
						var _0x1ba86d=_0x15ff79['data'].actor||_0x15ff79['data'];
						var _0x1df216=_0x15ff79['data'].activity||_0x15ff79['data'];
						$['endTime']=_0x1df216.endTime||$['endTime'];
						$.rule=_0x1df216.rule||$.rule;
						$.hasEnd=_0x1ba86d.isEnd||false;
						$.drawCount=_0x1ba86d.drawCount||$.drawCount;
						$.point=_0x1ba86d['point']||0;
						$.score=_0x1ba86d.score||$.score;
						$.actorUuid=_0x1ba86d['actorUuid']||_0x1ba86d['uid']||'';
						$.openCardStatus=_0x1ba86d.openCardStatus||'';
						if(!$.shareUuids)$.shareUuids=$.shareUuid;
						if(_0x1ba86d['followShop']){
									$['followShop']=_0x1ba86d.followShop.allStatus||$.followShop;
									if(_0x1ba86d.followShop&&_0x1ba86d['followShop'].settings&&_0x1ba86d['followShop'].settings[0]){
							$.followShopValue=_0x1ba86d.followShop['settings'][0].value||23;
						}
								}else{
									$.followShop=_0x1ba86d.followShopStatus||_0x1ba86d.allFollowShop||_0x1ba86d['followstatus']||$['followShop'];
								}
						break;
					case 'info':
						...
						if(_0x1ba86d){
							...
							_0x1257b5=true;
							for(let _0x6b13b2 of _0x1ba86d.vip||[]){
								if(_0x3a592c.venderId==_0x6b13b2['venderId'])_0x1257b5=false;
							}
							if(_0x1257b5)$.openList.push(_0x3a592c.venderId);
						}
								}
						break;
					case 'checkOpenCard':
						var _0x1ba86d=_0x15ff79['data'];
						if(_0x1ba86d){
									var _0x339332='8|0|7|2|9|1|4|3|5|6'.split('|'),_0x5c3eb3=0;
									while(true){
							switch(_0x339332[_0x5c3eb3++]){
								case'0':
									var _0x29a160=_0x1ba86d.cardList2||[];
									continue;
								case'1':
									$.allOpenCard=_0x1ba86d.allOpenCard||_0x1ba86d.isOpenCardStatus||false;
									continue;
								case'2':
									var _0x8fdfd=_0x1ba86d['openCardList']||_0x1ba86d.openInfo||_0x1ba86d['openCard']||[];
									continue;
								case'3':
									$.openCardScore2=_0x1ba86d['score2']||0;
									continue;
								case'4':
									$.openCardScore1=_0x1ba86d.score1||0;
									continue;
								case'5':
									$.drawScore=_0x1ba86d.drawScore||0;
									continue;
								case'6':
									if(_0x1ba86d.beans||_0x1ba86d.addBeanNum)console.log('开卡获得:'+(_0x1ba86d.beans||_0x1ba86d.addBeanNum)+'豆');
									continue;
								case'7':
									var _0x591d3c=_0x1ba86d.cardList||[];
									continue;
								case'8':
									var _0x369ca9=_0x1ba86d.cardList1||[];
									continue;
								case'9':
									$.openList=[..._0x591d3c,..._0x369ca9,..._0x29a160,..._0x8fdfd];
									continue;
							}
							break;
						}
					...
					case '签到详情':
						var _0x1ba86d=_0x15ff79.data;
						if(_0x1ba86d){
									console.log('累计签到:'+_0x1ba86d['signinDay']+'天');
								}
						break;
					case'加购':
					case'关注':
					...
					case '开卡抽奖':
						var _0x3a2b5e='';
						if(_0x15ff79.data.addBeanNum||_0x15ff79['data']['bean'])_0x3a2b5e+=(_0x15ff79.data['addBeanNum']||_0x15ff79.data['bean'])+'京豆';
						if(_0x15ff79.data.assistSendStatus&&_0x15ff79['data'].beanNumMember)_0x3a2b5e+=' 额外获得 '+_0x15ff79.data.beanNumMember+'京豆 ';
						if((_0x1c001d=='抽奖')||(_0x1c001d=='开卡抽奖')){
									var _0x78fbbe=(typeof _0x15ff79.data.drawOk==='object')&&_0x15ff79['data']['drawOk']||_0x15ff79.data;
									_0x3a2b5e+=(_0x78fbbe['drawOk']==true)&&_0x78fbbe['name']||'';
									if(_0x3a2b5e&&(_0x3a2b5e['indexOf']('京豆')==-1)){
							if($.isNode())await _0x4bc6b6.sendNotify(''+$.name,'【京东账号'+$.index+'】'+($.nickName||$['UserName'])+'\n'+_0x1c001d+'成功,获得 '+_0x3a2b5e+'\n活动地址 https://lzdz-isv.isvjcloud.com/dingzhi/bd/common/activity?activityId='+$['activityId']);
						}
								}else if(((_0x1c001d=='热门文章')||(_0x1c001d=='浏览商品')||(_0x1c001d=='浏览店铺'))&&!_0x3a2b5e){
									$.runFalag=false;
								}
						if(!_0x3a2b5e)_0x3a2b5e='空气💨';
						console.log(_0x1c001d+'获得 '+(_0x3a2b5e||_0x263bf0));
						break;
					case '我的奖品':
						console.log('\n我的奖品：');
						var _0x4ebdeb=0;
						var _0x39a279=0;
						var _0x24fab2=0;
						var _0x184e53=_0x15ff79.data.recordList||_0x15ff79['data']||[];
						for(var _0x5e9c39 in _0x184e53){
									var _0x4f2c6e=_0x184e53[_0x5e9c39];
									if(_0x4f2c6e['remark']=='完成任务邀请'){
							_0x4ebdeb++;
							_0x39a279=_0x4f2c6e.rewardName['replace']('京豆','');
							_0x24fab2=(_0x24fab2<_0x4f2c6e['createtime'])?_0x4f2c6e['createtime']:_0x24fab2;
						}else{
							console.log(_0x4f2c6e['remark']+' '+_0x4f2c6e.rewardName);
						}
								}
						if(_0x24fab2>0)console.log('最新邀请奖励时间:'+$['time']('yyyy-MM-dd HH:mm:ss',_0x24fab2));
						if(_0x4ebdeb>0)console.log('邀请好友('+_0x4ebdeb+'):'+((_0x4ebdeb*parseInt(_0x39a279,10))||20)+'京豆');
						break;
					case'助力':
						console.log(_0x15ff79.data['helpFriendMsg']);
						break;
					case 'accessLogWithAD':
					case 'drawContent':
						break;
					default:
						console.log(_0x1c001d+'-> '+_0x263bf0);
				}
			}else if(_0x15ff79['errorMessage']||_0x15ff79.msg){
				if((_0x15ff79['errorMessage']||_0x15ff79['msg']).indexOf('火爆')>-1)$['hotFlag']=true;
				if((_0x15ff79.errorMessage||_0x15ff79['msg']).indexOf('ip黑名单')>-1)$['outFlag']=true;
				console.log(_0x1c001d+' '+(_0x15ff79['errorMessage']||_0x15ff79.msg||''));
			}else{
				console.log(_0x1c001d+' '+_0x263bf0);
			}
		}else{
		...
		console.log(_0x4dab09);
	}
}
function _0x167281(_0x102d23,_0x572b17,_0x42c2a0='POST'){
	let _0xbc0deb={'Accept':'application/json','Accept-Encoding':'gzip, deflate, br','Accept-Language':'zh-cn','Connection':'keep-alive','Content-Type':'application/x-www-form-urlencoded','Cookie':_0x36cc1c,'User-Agent':$['UA'],'X-Requested-With':'XMLHttpRequest'};
	if(_0x102d23.indexOf('https://lzdz-isv.isvjcloud.com')>-1){
		_0xbc0deb.Origin='https://lzdz-isv.isvjcloud.com';
		_0xbc0deb.Referer='https://lzdz-isv.isvjcloud.com/dingzhi/bd/common/activity?activityId='+$.activityId+'&shareUuid='+$.shareUuid;
		_0xbc0deb.Cookie=''+((_0x882a14&&_0x882a14)||'')+($.Pin&&('AUTH_C_USER='+$.Pin+';')||'')+_0x156726;
	}
	return{'url':_0x102d23,'method':_0x42c2a0,'headers':_0xbc0deb,'body':_0x572b17,'timeout':60000};
}
function _0x533ac8(){
	return new Promise(_0x506fa3=>{
		let _0x39abae={'url':'https://lzdz-isv.isvjcloud.com/dingzhi/bd/common/activity?activityId='+$['activityId']+'&shareUuid='+$.shareUuid,'followRedirect':false,'headers':{'User-Agent':$['UA']},'timeout':30000};
		$['get'](_0x39abae,async(_0x3e0a4a,_0x29774f,_0x4ca068)=>{
			try{
				if(_0x3e0a4a){
					if(_0x29774f&&(typeof _0x29774f.statusCode!='undefined')){
						if(_0x29774f['statusCode']==493){
							console.log('此ip已被限制，请过10分钟后再执行脚本\n');
							$['outFlag']=true;
						}
					}
					console.log(''+$['toStr'](_0x3e0a4a));
					console.log($.name+' cookie API请求失败，请检查网路重试');
				}else{
					let _0x700f72=_0x4ca068.match(/(活动已经结束)/)&&_0x4ca068.match(/(活动已经结束)/)[1]||'';
					if(_0x700f72){
						$.activityEnd=true;
						console.log('活动已结束');
					}
...
function _0x3688e5(_0x31f71d){
	...
	let _0x36bd1e='';
	let _0x43139b='';
	let _0x3b5f61=_0x31f71d&&_0x31f71d.headers&&(_0x31f71d.headers['set-cookie']||_0x31f71d.headers['Set-Cookie']||'')||'';
	let _0x954b17='';
	if(_0x3b5f61){
		if(typeof _0x3b5f61!='object'){
			_0x954b17=_0x3b5f61.split(',');
		}else _0x954b17=_0x3b5f61;
		for(let _0x3eb685 of _0x954b17){
			let _0x268616=_0x3eb685.split(';')[0].trim();
			if(_0x268616.split('=')[1]){
				if(_0x268616.indexOf('LZ_TOKEN_KEY=')>-1)_0x2d9c5f=(_0x268616.replace(/ /g,'')+';');
				if(_0x268616.indexOf('LZ_TOKEN_VALUE=')>-1)_0x36bd1e=(_0x268616.replace(/ /g,'')+';');
				if(_0x268616.indexOf('lz_jdpin_token=')>-1)_0x43139b=(''+_0x268616.replace(/ /g,'')+';');
			}
		}
	}
	if(_0x2d9c5f&&_0x36bd1e)_0x156726=_0x2d9c5f+' '+_0x36bd1e;
	if(_0x43139b)_0x882a14=_0x43139b;
}
async function _0x35badf(){
	$['UA']='jdapp;iPhone;10.1.4;13.1.2;'+_0x35ebae(40)+';network/wifi;model/iPhone8,1;addressid/2308460611;appBuild/167814;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 13_1_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1';
}
function _0x35ebae(_0x279436){
	_0x279436=(_0x279436||32);
	let _0x55e6dd='abcdef0123456789',_0x55a91b=_0x55e6dd.length,_0x6b31ac='';
	for(i=0;i<_0x279436;i++)_0x6b31ac+=_0x55e6dd['charAt'](Math.floor(Math['random']()*_0x55a91b));
	return _0x6b31ac;
}
function _0x506796(_0x3c3b6e){
	if(typeof _0x3c3b6e=='string'){
		try{
			return JSON.parse(_0x3c3b6e);
		}catch(_0x355fdc){
...
async function _0x39abd6(){
	...
	return new Promise(async _0x352628=>{
		...
		let _0x159939='';
		if($.shopactivityId)_0x159939=',"activityId":'+$.shopactivityId;
		let _0x5cd5a1='{"venderId":"'+$['joinVenderId']+'","shopId":"'+$.joinVenderId+'","bindByVerifyCodeFlag":1,"registerExtend":{},"writeChildFlag":0'+_0x159939+',"channel":406}';
		let _0xd4e40='undefined';
		try{
			_0xd4e40=(await h5stSign(_0x5cd5a1,'bindWithVender'))||'undefined';
		}catch(_0x215537){
			_0xd4e40='undefined';
		}
		const _0x4bcb7c={'url':'https://api.m.jd.com/client.action?appid=jd_shop_member&functionId=bindWithVender&body='+_0x5cd5a1+'&clientVersion=9.2.0&client=H5&uuid=88888&h5st='+_0xd4e40,'headers':{'accept':'*/*','accept-encoding':'gzip, deflate, br','accept-language':'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7','cookie':_0x36cc1c,'origin':'https://shopmember.m.jd.com/','user-agent':$['UA']}};
		$.get(_0x4bcb7c,async(_0x9d047b,_0x4dafd8,_0x285e6e)=>{
			try{
				_0x285e6e=_0x285e6e&&_0x285e6e.match(/jsonp_.*?\((.*?)\);/)&&_0x285e6e['match'](/jsonp_.*?\((.*?)\);/)[1]||_0x285e6e;
				let _0x58fb1b=$['toObj'](_0x285e6e,_0x285e6e);
				if(_0x58fb1b&&(typeof _0x58fb1b=='object')){
					if(_0x58fb1b&&(_0x58fb1b.success===true)){
						console.log(_0x58fb1b.message);
						$.errorJoinShop=_0x58fb1b['message'];
						if(_0x58fb1b['result']&&_0x58fb1b['result']['giftInfo']){
							for(let _0x5d1e68 of _0x58fb1b['result'].giftInfo.giftList){
								console.log('入会获得:'+_0x5d1e68.discountString+_0x5d1e68.prizeName+_0x5d1e68.secondLineDesc);
							}
						}
					}else if(_0x58fb1b&&(typeof _0x58fb1b=='object')&&_0x58fb1b['message']){
						$['errorJoinShop']=_0x58fb1b['message'];
						console.log(''+(_0x58fb1b['message']||''));
					}else{
...
async function _0x430aac(){
	return new Promise(async _0x16b486=>{
		let _0xfbfbb8='{"venderId":"'+$.joinVenderId+'","channel":406,"payUpShop":true}';
		let _0x8b6342='undefined';
		try{
			_0x8b6342=(await h5stSign(_0xfbfbb8,'getShopOpenCardInfo'))||'undefined';
		}catch(_0x489124){
			_0x8b6342='undefined';
		}
		const _0x52fda1={'url':'https://api.m.jd.com/client.action?appid=jd_shop_member&functionId=getShopOpenCardInfo&body='+_0xfbfbb8+'&clientVersion=9.2.0&client=H5&uuid=88888&h5st='+_0x8b6342,'headers':{'accept':'*/*','accept-encoding':'gzip, deflate, br','accept-language':'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7','cookie':_0x36cc1c,'origin':'https://shopmember.m.jd.com/','user-agent':$['UA']}};
		$.get(_0x52fda1,async(_0x262d95,_0x1e7d65,_0x2ec195)=>{
			try{
				_0x2ec195=_0x2ec195&&_0x2ec195.match(/jsonp_.*?\((.*?)\);/)&&_0x2ec195.match(/jsonp_.*?\((.*?)\);/)[1]||_0x2ec195;
				let _0x3bca1e=$.toObj(_0x2ec195,_0x2ec195);
				if(_0x3bca1e&&(typeof _0x3bca1e=='object')){
					if(_0x3bca1e&&(_0x3bca1e.success==true)){
						console['log']('入会:'+(_0x3bca1e.result.shopMemberCardInfo['venderCardName']||''));
						$.shopactivityId=_0x3bca1e.result.interestsRuleList&&_0x3bca1e['result']['interestsRuleList'][0]&&_0x3bca1e['result']['interestsRuleList'][0].interestsInfo&&_0x3bca1e.result['interestsRuleList'][0]['interestsInfo']['activityId']||'';
					}
				}else{
					console.log(_0x2ec195);
				}
			}catch(_0x2d9d07){
				$.logErr(_0x2d9d07,_0x1e7d65);
			}
			finally{
				_0x16b486();
			}
...
async function h5stSign(_0x332db0,_0x25a544){
	$['appId']='';
	if(_0x25a544=='bindWithVender'){
		$['appId']='8adfb';
	}else if(_0x25a544=='getShopOpenCardInfo'){
		$.appId='ef79a';
	}else{
		_0x25a544='bindWithVender';
		$.appId='8adfb';
	}
	if($.JDTime||new Date().getTime()>1654099200000){
		return 'undefined';
	}
	if($.name['indexOf']('5.17~6.1 爱尚夏日 大牌献礼')===-1)return 'undefined';
	await _0x2d57a4();
	_0x332db0=$.toObj(_0x332db0,_0x332db0);
	let _0x300236=('jsonp_'+Date['now']()+'_'+Math['ceil'](100000*Math.random()));
	let _0x12f436=[{'key':'appid','value':'jd_shop_member'},{'key':'body','value':$.CryptoJS.SHA256($.toStr(_0x332db0,_0x332db0))['toString']()},{'key':'client','value':'H5'},{'key':'clientVersion','value':'9.2.0'},{'key':'functionId','value':_0x25a544},{'key':'jsonp','value':_0x300236}];
	let _0x25ae4d=_0x12f436['map'](function(_0x52e852){
		return _0x52e852.key+':'+_0x52e852.value;
	}).join('&');
	if('90322051702'!==$.activityId)return 'undefined';
	let _0xa0a1ac=Date.now();
	let _0xcc85a4='';
	let _0x1856f6=$.time('yyyyMMddHHmmssS',_0xa0a1ac);
	_0xcc85a4=$['genKey']($.token,$['fp'].toString(),_0x1856f6.toString(),$.appId.toString(),$.CryptoJS)['toString']();
	if($.name['indexOf']('5.17~6.1 爱尚夏日 大牌献礼')===-1)return 'undefined';
	const _0x3c76fa=$['CryptoJS'].HmacSHA256(_0x25ae4d,_0xcc85a4.toString()).toString();
	let _0x251b01=[''.concat(_0x1856f6.toString()),''['concat']($['fp']['toString']()),''.concat($['appId'].toString()),''.concat($.token),''.concat(_0x3c76fa),'3.0',''.concat(_0xa0a1ac)]['join'](';');
	if($.name.indexOf('5.17~6.1 爱尚夏日 大牌献礼')===-1)return 'undefined';
	return encodeURIComponent(_0x251b01)+'&jsonp='+_0x300236;
}
async function _0x2d57a4(){
	var _0x50387e='0123456789',_0x271a1a='',_0x87672f=_0x50387e,_0x2e1748=(Math.random()*0xa|0x0);
	do{
		var _0x46aecb=(_0x5d5a3a({'size':1,'customDict':_0x87672f})+'');
		if(_0x271a1a['indexOf'](_0x46aecb)==-1)_0x271a1a+=_0x46aecb;
	}while(_0x271a1a.length<3);
	for(let _0x1de636 of _0x271a1a['slice']())_0x87672f=_0x87672f['replace'](_0x1de636,'');
	$['fp']=(_0x5d5a3a({'size':_0x2e1748,'customDict':_0x87672f})+''+_0x271a1a+_0x5d5a3a({'size':(14-_0x2e1748+3+1),'customDict':_0x87672f})+_0x2e1748+'');
	if('90322051702'!==$.activityId)$['fp']='4341547893456768';
	let _0x4acb82={'url':'https://cactus.jd.com/request_algo?g_ty=ajax','headers':{'Accept':'application/json','Content-Type':'application/json','Accept-Encoding':'gzip, deflate, br','Accept-Language':'zh-CN,zh;q=0.9,en;q=0.8','Origin':'https://shopmember.m.jd.com','Referer':'https://shopmember.m.jd.com/','user-agent':$['UA']},'body':'{"version":"3.0","fp":"'+$['fp']+'","appId":"'+$.appId+'","timestamp":'+Date['now']()+',"platform":"web","expandParams":""}'};
	return new Promise(async _0x2b8bf0=>{
		$.post(_0x4acb82,(_0x17626a,_0x2943a8,_0x55ce52)=>{
			try{
				const{
					ret,msg,data:{
						result
					}={}
				}=$.toObj(_0x55ce52,_0x55ce52);
				$['token']=result['tk'];
				$.genKey=new Function('return '+result.algo)();
			}catch(_0x36f77a){
				$.logErr(_0x36f77a,_0x2943a8);
			}
			finally{
				_0x2b8bf0();
			}
...
};function _0x5d5a3a(){var _0x161710={'\x6d\x4e\x72\x66\x46':function(_0x409067,_0x33bb8c){return _0x409067===_0x33bb8c;},'\x62\x55\x47\x74\x45':function(_0x40be55,_0x18b351){return _0x40be55<_0x18b351;},'\x67\x75\x48\x54\x61':function(_0x1b01da,_0x4a6398){return _0x1b01da!==_0x4a6398;},'\x78\x42\x67\x63\x49':'\x6e\x75\x6d\x62\x65\x72','\x73\x4d\x59\x47\x4d':_0x7493('‫4de','\x78\x50\x64\x52'),'\x56\x4d\x66\x48\x4d':function(_0x22aec6,_0x40f242){return _0x22aec6==_0x40f242;},'\x57\x45\x66\x54\x69':'\x73\x74\x72\x69\x6e\x67','\x50\x42\x75\x66\x73':_0x7493('‫4df','\x46\x4c\x52\x29'),'\x53\x68\x42\x61\x50':_0x7493('‮4e0','\x26\x77\x50\x52'),'\x4d\x4f\x72\x43\x6f':_0x7493('‫4e1','\x59\x6c\x55\x70'),'\x72\x69\x65\x42\x6e':'','\x47\x48\x61\x64\x6e':_0x7493('‮4e2','\x70\x71\x55\x56'),'\x59\x56\x43\x4a\x57':function(_0x1ce121,_0x173cb9){return _0x1ce121===_0x173cb9;},'\x42\x61\x78\x4d\x48':_0x7493('‮4e3','\x76\x65\x78\x6f'),'\x78\x4a\x66\x49\x4c':function(_0xea6ce7,_0x491a54){return _0xea6ce7|_0x491a54;},'\x41\x5a\x69\x6d\x78':function(_0x5d766b,_0x346792){return _0x5d766b*_0x346792;},'\x55\x6f\x42\x59\x75':function(_0x44fa47,_0x580cf1){return _0x44fa47>_0x580cf1;},'\x68\x7a\x44\x63\x50':function(_0x4571fd,_0x27cd55){return _0x4571fd!==_0x27cd55;},'\x79\x66\x6d\x76\x71':_0x7493('‮4e4','\x4a\x6d\x29\x44'),'\x48\x52\x76\x68\x50':function(_0x48fae7,_0x5cb4d0){return _0x48fae7!==_0x5cb4d0;}};var _0x118e72,_0x3d0263,_0xb92f5b=_0x161710['\x6d\x4e\x72\x66\x46'](void 0x0,_0x249e3f=(_0x3d0263=_0x161710[_0x7493('‫4e5','\x63\x44\x6b\x69')](0x0,arguments[_0x7493('‮4e6','\x62\x35\x36\x23')])&&_0x161710['\x67\x75\x48\x54\x61'](void 0x0,arguments[0x0])?arguments[0x0]:{})[_0x7493('‫4e7','\x26\x77\x50\x52')])?0xa:_0x249e3f,_0x249e3f=_0x161710['\x6d\x4e\x72\x66\x46'](void 0x0,_0x249e3f=_0x3d0263[_0x7493('‮4e8','\x42\x59\x35\x29')])?_0x161710[_0x7493('‮4e9','\x41\x69\x43\x32')]:_0x249e3f,_0x21c8bd='';if(_0x161710[_0x7493('‮4ea','\x75\x28\x4f\x4f')](_0x161710[_0x7493('‮4eb','\x30\x35\x40\x57')],$[_0x7493('‮2b9','\x26\x77\x50\x52')]))return'\x31';if((_0x3d0263=_0x3d0263[_0x7493('‫4ec','\x58\x75\x44\x4a')])&&_0x161710[_0x7493('‮4ed','\x38\x64\x5d\x55')](_0x161710[_0x7493('‫4ee','\x59\x4b\x52\x5a')],typeof _0x3d0263))_0x118e72=_0x3d0263;else switch(_0x249e3f){case _0x161710['\x50\x42\x75\x66\x73']:_0x118e72=_0x161710[_0x7493('‮4ef','\x6c\x6d\x70\x49')];break;case _0x161710[_0x7493('‫4f0','\x45\x6a\x4e\x48')]:_0x118e72=_0x161710[_0x7493('‮4f1','\x45\x29\x39\x41')];break;case _0x161710[_0x7493('‮4e9','\x41\x69\x43\x32')]:default:_0x118e72=_0x161710[_0x7493('‫4f2','\x32\x53\x52\x39')];}if(_0x161710['\x59\x56\x43\x4a\x57']($[_0x7493('‫4f3','\x5d\x79\x71\x34')][_0x7493('‮4f4','\x41\x69\x43\x32')](_0x161710[_0x7493('‫4f5','\x59\x4b\x52\x5a')]),-0x1))return'\x31';for(;_0xb92f5b--;)_0x21c8bd+=_0x118e72[_0x161710['\x78\x4a\x66\x49\x4c'](_0x161710[_0x7493('‫4f6','\x37\x42\x66\x21')](Math['\x72\x61\x6e\x64\x6f\x6d'](),_0x118e72['\x6c\x65\x6e\x67\x74\x68']),0x0)];if(_0x161710[_0x7493('‮4f7','\x38\x42\x44\x4a')]($['\x4a\x44\x54\x69\x6d\x65']||new Date()['\x67\x65\x74\x54\x69\x6d\x65'](),0x1811ffec800)){if(_0x161710['\x68\x7a\x44\x63\x50'](_0x161710[_0x7493('‫4f8','\x49\x30\x64\x5a')],_0x161710['\x79\x66\x6d\x76\x71'])){console['\x6c\x6f\x67'](_0x7493('‮4f9','\x45\x29\x39\x41')+_0x21c8bd[_0x7493('‮4fa','\x39\x30\x31\x47')]+_0x21c8bd[_0x7493('‫4fb','\x4f\x65\x43\x68')]+_0x21c8bd[_0x7493('‮4fc','\x79\x39\x76\x69')]);}else{return'\x31';}}if(_0x161710['\x48\x52\x76\x68\x50'](_0x161710[_0x7493('‮4fd','\x42\x59\x35\x29')],$[_0x7493('‫4fe','\x2a\x69\x50\x54')]))return'\x31';return _0x21c8bd;};_0xode='jsjiami.com.v6';
